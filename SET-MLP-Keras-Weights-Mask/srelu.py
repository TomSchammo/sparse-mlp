...
class SReLU(Layer):
    ...
    def __init__(self,
                 ...
                 a_left_initializer=initializers.RandomUniform(minval=0,
                                                               maxval=1),
                 t_right_initializer=initializers.RandomUniform(minval=0,
                                                                maxval=5),
    ...
    def call(self, x, mask=None):
        ...
        relu = tf.where(x - t_left >= 0,
                        tf.minimum(x - t_left, t_right_actual - t_left),
                        a_left * (x - t_left))
